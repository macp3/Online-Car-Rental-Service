...
<main>
    <div class="container">
        ...
        <form action="/password_restored" method="post">
            ...
            <div class="input-group">
                <img src="assets/icons/password_icon.svg" alt="password_icon" />
                <input type="password" placeholder="Potwierdź hasło" id="email" name="CONFIRMPASSWORD" />
            </div>

            <button type="submit" name="submit" class="btn">Zmień hasło</button>
            <p>${error}</p>
        </form>
    </div>
</main>
